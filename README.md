# Restoran_SYSTEM
Приветсвую! Пару слов о самом проекте, проект представляет из себя внутренюю систему для для не большого кафе(https:\\api.dev.youthcafe.ru)\
...
То же самое если нужно не получить а создать или изменить(состояние) заказ/а.\*Ниже есть API endpoint где можно увидеть что происходит при отправке запроса на тот или иной url*
***
## Stack
### Backend
    Python
